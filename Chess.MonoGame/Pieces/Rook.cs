...
namespace Chess.MonoGame.Pieces
{
    public class Rook : ChessPiece
    {
        ...
        public Rook(Alliance alliance, Texture2D texture, IEnumerable<IPieceBehaviour> pieceBehaviours, int row, int column, bool hasMoved, int materialValue, ChessPieceFactory factory) : base(alliance, texture, pieceBehaviours, row, column, hasMoved, materialValue, factory)
        {
